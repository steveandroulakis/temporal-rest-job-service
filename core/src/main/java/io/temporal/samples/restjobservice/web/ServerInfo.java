...
package io.temporal.samples.restjobservice.web;
...
public class ServerInfo {
  ...
  public static String getTaskqueue() {
    String taskqueue = System.getenv("TEMPORAL_REST_JOB_SERVICE_TASKQUEUE");
    return taskqueue != null && !taskqueue.isEmpty() ? taskqueue : "RestJobService";
  }
